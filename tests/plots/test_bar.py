...
def test_bar_raises_error_for_none_input():
    """Ensure bar plot raises TypeError when input is None."""
    with pytest.raises(TypeError):
        shap.plots.bar(None, show=False)


def test_bar_raises_error_for_empty_dict():
    """Ensure bar plot raises ValueError when input is an empty dictionary."""
